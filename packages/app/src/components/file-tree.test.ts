...
beforeAll(async () => {
  ...
  mock.module("@openmods-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@openmods-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@openmods-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@openmods-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))

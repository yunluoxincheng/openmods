...
import type { AssistantMessage, Part, UserMessage } from "@openmods-ai/sdk/v2"
...
describe("transcript", () => {
  describe("formatAssistantHeader", () => {
    ...
    test("includes metadata when enabled", () => {
      ...
      expect(result).toBe("## Assistant (Minecraft · claude-sonnet-4-20250514 · 5.4s)\n\n")
    })
    ...
    test("handles missing completed time", () => {
      ...
      expect(result).toBe("## Assistant (Minecraft · claude-sonnet-4-20250514)\n\n")
    })
